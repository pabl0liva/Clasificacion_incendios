## Este script contiene diversas funciones que pueden facilitar la inspección del archivo y 
## ciertas tareas propias de la modelización predictiva. 

## NOTA: En general funcionan sobre data.frame, en el caso de tener un objeto tibble y debido a su especial tratamiento 
## de subconjuntos seleccionados mediante la indexación de columnas clasica, se pueden producir fallos. 
## Lo ideal sería convertir a data.frame precvio a la aplicación.
...
## Gáficos para análisis de relaciones con la variable respuesta
...
# transformada con los outliers como missing (argumento [[1]]) y el conteo de outliers (argumento [[2]]) para hacerse una idea.
